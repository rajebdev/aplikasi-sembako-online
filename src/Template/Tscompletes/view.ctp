...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tscomplete'), ['action' => 'edit', $tscomplete->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tscomplete'), ['action' => 'delete', $tscomplete->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tscomplete->id)]) ?> </li>
...
<div class="tscompletes view large-9 medium-8 columns content">
    <h3><?= h($tscomplete->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($tscomplete->transactionstatus)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($tscomplete->transactionstatus as $transactionstatus): ?>
            <tr>
