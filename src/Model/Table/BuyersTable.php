 ...
 * Buyers Model
 *
 * @property \App\Model\Table\BuyerdetailsTable&\Cake\ORM\Association\BelongsTo $Buyerdetails
...
class BuyersTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['buyerdetail_id'], 'Buyerdetails'));
